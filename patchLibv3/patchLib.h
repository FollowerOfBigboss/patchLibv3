 ...
 */
typedef std::function<bool(CChild*)> CMDFUNCTION;
...
class CPatchLib
{
	 ...
	 * Singleton instance.
	 */
	static std::shared_ptr< CPatchLib > m_vInstance;

	/**
	 * Window object.
	 */
	std::shared_ptr< CWindow > m_vWindow;
	 ...
	 * Music variables
	 */
	std::shared_ptr< CMusic >	m_vMusicObject;
...
public: // Singleton instance.
	static std::shared_ptr< CPatchLib > instance(void);
